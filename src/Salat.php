 ...
 *
 * Filename:   Salat.php Original    Author(s): Khaled Al-Sham'aa <khaled@ar-php.org>
 *
 ...
 * @link      http://www.ar-php.org
 */
class Salat extends I18N_Arabic
{
     ...
     *
     * @param decimal|float $l1 Latitude of location you want to calculate Salat time in
     * @param decimal|float $l2 Longitude of location you want to calculate Salat time in
     ...
     * @param decimal|float $sunriseArc Sun rise arc (default value is -0.833333)
     * @param decimal|float $ishaArc Isha arc (default value is -18)
     * @param decimal|float $fajrArc Fajr arc (default value is -18)
